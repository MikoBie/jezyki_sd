...
Wyniki ankiety są podzielone na 12 różnych kategorii. Po lewej stronie znajduje się menu, w którym wypisane są wszystkie kategorie. W większości kategorii można wybrać jedną z dwóch możliwości: 
...
```{r form_of_course-table, layout="l-body-outset"}
cap <- sprintf(
  "W Ankiecie wzięło udział w sumie %.0f doktorantek i doktorantów, z czego %.0f kształci się na studiach doktoranckich, a %.0f w szkołach doktorskich.",
  data %>% nrow,
  data %>% filter(position == 'Doctoral Studies') %>% nrow(),
